...
if(isset($_POST['btn']))
{
$qry=mysqli_query($con,"select * from sregister where name='$uname' && reg='$password'");
$num=mysqli_num_rows($qry);
if($num==1)
{
$qry1=mysqli_query($con,"select * from sregister where name='$uname' && reg='$password'");
$row=mysqli_fetch_array($qry1);
$_SESSION['reg']=$row['reg'];
$_SESSION['class']=$row['year'];
	   ...
	   <table width="46%" border="0" align="center">
		...
		<td width="41%">&nbsp;</td>
         ...
         <tr>
           <td>&nbsp;</td>
           <td rowspan="2"><label>
           <a href="dashboard.html"><input name="btn" type="submit" id="btn" value="Login" />
             <a href="home1.html"><input type="reset" name="Submit2" value="Cancel" ></a>
           </label></td>
         </tr>
...
<br />
    <a href="http://binarytheme.com" style="color: #fff" target="_blank">Design by : binarytheme.com</a>
    </div>
     <!-- FOOTER SECTION END-->
